            ...
            <div className={styles.itemContainer}>
                ...
                <div className={`${styles.item} ${'glass-card'}`}>
                    ...
                    <div className={styles.itemContent}>
                        <h3 className={styles.itemTitle} >Hybrid Exoplanet Recognition and Model Evaluation System - HERMES</h3>
                ...
                <div className={`${styles.item} ${'glass-card'}`}>
                    ...
                    <div className={styles.itemContent}>
                        <h3 className={styles.itemTitle} >AI-Powered Mosquito Monitoring System</h3>
                ...
                <div className={`${styles.item} ${'glass-card'}`}>
                    ...
                    <div className={styles.itemContent}>
                        <h3 className={styles.itemTitle} >Smart Packaging Control & Demand Forecasting Web Application</h3>
                ...
                <div className={`${styles.item} ${'glass-card'}`}>
                    ...
                    <div className={styles.itemContent}>
                        <h3 className={styles.itemTitle} >Exercise Posture Suggestion System</h3>
